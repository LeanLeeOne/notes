## 索引[[1]](https://doris.apache.org/zh-CN/docs/dev/data-table/index/index-overview/)
...
## Join Shuffle[[2]](https://doris.apache.org/zh-CN/docs/4.x/query-data/join#doris-hash-join-的实现方式)
...
### Colocate Join[[3]](https://doris.apache.org/zh-CN/docs/4.x/query-acceleration/colocation-join)
