...
<table cellspacing="0" cellpadding="0">
   ...
   <tbody>
      ...
      <tr>
         <td>PriorityBlockingQueue</td><td>无界队列</td><td>支持按优先级排序，默认自然序进行排序，也可通过实现<span style=background:#c2e2ff>compareTo()</span>来指定排序规则。<br/>会阻塞出队，不会阻塞入队，所以需要预防<code>OutOfMemoryError</code>。</td>
      </tr>
      <tr>
