...
​	原标题名：《Java Synchronized 重量级锁原理深入剖析上(互斥篇)》





下图来自[Lock Lock Lock: Enter!](https://jpbempel.github.io/2013/03/25/lock-lock-lock-enter.html)

![img](../images/2/mark-word.png)

下图来自[Java Synchronized 偏向锁/轻量级锁/重量级锁的演变过程](https://www.jianshu.com/p/22b5a0a78a9b)<span style=background:#ffee7c>不是4字节吗？怎么变成8字节了？</span>

![img](../images/2/mark-word-bits.png)

下图来自[Synchronization](https://wiki.openjdk.java.net/display/HotSpot/Synchronization)
