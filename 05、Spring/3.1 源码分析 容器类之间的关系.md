以**AnnotationConfigApplicationContext**为例，以<span style=background:#b3b3b3>BeanFactory.getBean()</span>为线索探究<span style=background:#ffb8b8>IoC容器</span>中[各类之间的关系](https://zhuanlan.zhihu.com/p/74832770)。
