...
#### 服务和项目[7](https://yeasy.gitbook.io/docker_practice/compose/introduction)：
...
`etcd`是[Fedora CoreOS](https://getfedora.org/coreos?stream=stable)下的一个高可用的分布式<u>键值对</u>数据库，可用于管理配置信息和服务发现。
