...
[变量的本质是一小块内存单元](https://www.php.cn/java-article-458265.html)，而[Java中的变量分为2种](https://www.liaoxuefeng.com/wiki/1252599548343744/1255883729079552)：<u>基本变量</u>和<u>引用变量</u>。
...
当变量为对象类型时，保存的是对象的地址，也就是指针，此时称“变量引用某对象”或“变量指向某对象”，所以这种变量也被称为引用变量。
