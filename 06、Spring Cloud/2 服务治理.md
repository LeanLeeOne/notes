...
如[上图](https://www.cnblogs.com/jichi/p/12797557.html)所示，**Eureka**有如下行为：
...
**Zookeeper**常用来维护分布式系统中的信息，可以用来做注册中心。

[但对注册中心来说](https://mp.weixin.qq.com/s?__biz=MzI4MTY5NTk4Ng==&mid=2247489041&idx=1&sn=b58745994c0c98662e2330c966b5036f&source=41#wechat_redirect)，应侧重AP，而非CP，即，保证服务之间的连通，而**Zookeeper**是一个CP系统，不完全适合做注册中心。

另外：

- **Zookeeper**会将内存中的数据以及数据的变更历史持久化到磁盘，而注册中心更关注实时数据，持久化这一行为对注册中心来说也是多余的。
- **Zookeeper**的服务健康检查的粒度太粗，仅针对TCP连接，而非服务能力的健康。
