...
其中<span style=background:#c9ccff>Redo Log</span>、<span style=background:#f8d2ff>Undo Log</span>、<span style=background:#c2e2ff>Bin Log</span>比较重要，而<span style=background:#c9ccff>Redo Log</span>与<span style=background:#f8d2ff>Undo Log</span>与**事务**相关，也称为事务日志。
